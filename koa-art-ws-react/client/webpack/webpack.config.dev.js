...
Object.keys(baseWebpackConfig.entry).forEach(function(name) {
  ...
  baseWebpackConfig.entry[name] = Array.isArray(baseWebpackConfig.entry[name])
    ? hotLoaders.concat(baseWebpackConfig.entry[name])
    : [...hotLoaders, baseWebpackConfig.entry[name]];
});
